...
Log in at `https://opensocial-sandbox.ddev.site` with username `admin` / password `admin`.
...
GPL-2.0-or-later. See [`LICENSE.txt`](LICENSE.txt). This is the licence used by both [Drupal](https://www.drupal.org/about/licensing) and [Open Social](https://github.com/goalgorilla/open_social/blob/main/LICENSE.txt).
